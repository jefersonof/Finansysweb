...
class EntidadesListe Extends TPage
{
	...
	public function __construct()
	{
		...
		$this->datagrid->addQuickColumn('Código', 'COD_INT', 'center' );
		$this->datagrid->addQuickColumn('Nome', 'RAZAO_SOCIAL', 'center');
		
			
		$this->datagrid->addQuickAction('Editar' , new TDataGridAction(array('EntidadesForm', 'onEdit')), 'COD_INT', 'fa:edit blue');
		...
		//cria os btn
		$btn_incluir = TButton::create('btn_incluir' ,array('EntidadesForm', 'onEdit'), ('Incluir'), 'fa: fa-plus blue' );
	...
	*/
	...
	/*
	  Seta os filtros como vazio e chama o onReload()	
	*/
