...
class cadContrato Extends TPage
{
	...
	{	
		...
		$obj->COD_INT        = $data['ENTIDADE_COLETIVA'];
		...
		$obj->MATR_ORGAO     = $data['MATR_ORGAO'];
		//$obj->CONTRATO_OLD   = $data['CONTRATO_OLD'];//CODIGO
	...
	public function onAvancar($param)
	{
		...
		*/
			...
			$array_cad['PROPOSTA']          = $data->PROPOSTA_FIS;
			...
			$array_cad['CODIGO2']           = $data->CODIGO2; 
			$array_cad['ENTIDADE_COLETIVA'] = $data->COD_INT; 
			//$array_cad['TP_PLANO']          = $data->CODIGO;
			$array_cad['CODIGO']            = $data->CODIGO;
			$array_cad['NOME_PLANO']        = $data->NOME_PLANO;
			$array_cad['DT_CADASTRO']       = $data->DT_CADASTRO;//DT_PAGAMENTO
